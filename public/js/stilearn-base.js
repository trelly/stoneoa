$(function(){
    ...
    +'        <li><a id="normal-mode" href="#normal-mode">正常布局</a></li>'
    +'        <li><a id="fixedtop-mode" href="#fixedtop-mode">固定顶导</a></li>'
    +'        <li><a id="fixedside-mode" href="#fixedside-mode">固定边栏</a></li>'
    +'        <li><a id="fixedsideonly-mode" href="#fixedsideonly-mode">仅固定边栏</a></li>'
    +'    </ul>'
    +'    <div class="navigate-mode"><a href="#" title="设置布局模式" class="grd-teal corner-bottom"><i class="typicn-cog"></i></a></div>'
    +'</div>';
