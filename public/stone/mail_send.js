;(function(){
	...
	var uploadify = new CNC.Uploadify($('#upload'),{
		...
		'successCallback' : function(d){
			$('#attachment').append('<span type="panel" style="margin-left:20px;">'+d.result.name+'<input name="attachments" type="hidden" value="'+d.result.id+'" /><a href="javascript:;" class="icon-remove"  style="margin-top:4px; margin-left:10px;"></a></span> ');
		},
